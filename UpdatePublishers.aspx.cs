...
public partial class Publishers : System.Web.UI.Page
{
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "update publishers set pub_name ='" + TextBox2.Text + "',address1='" + TextBox3.Text + "',city='" + TextBox4.Text + "',state1='" + TextBox5.Text + "' where pub_id='" + TextBox1.Text + "'";
            cmd.ExecuteNonQuery();
