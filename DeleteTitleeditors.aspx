<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteTitleeditors.aspx.cs" Inherits="Titleeditors" %>
...
<body class="bodyimage">
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="405px" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
            <Columns>
