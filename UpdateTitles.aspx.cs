...
public partial class Titles : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "update titles set title='" + TextBox2.Text + "',type1='" + TextBox3.Text + "',pub_id='" + TextBox4.Text + "',price='" + TextBox5.Text + "',advance='"+TextBox6.Text+"',ytd_sales'"+TextBox7.Text+"',contract1='"+TextBox8.Text+"',notes='"+TextBox9.Text+"',pubdate='"+TextBox10.Text+"' where title_id='" + TextBox1.Text + "'";
            cmd.ExecuteNonQuery();
