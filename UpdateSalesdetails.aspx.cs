...
public partial class Salesdetails : System.Web.UI.Page
{
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "update salesdetails set title_id='" + TextBox2.Text + "',qty_ordered='" + TextBox3.Text + "',qty_shippled='" + TextBox4.Text + "',date1='" + TextBox5.Text + "' where sale_id='" + TextBox1.Text + "'";
            cmd.ExecuteNonQuery();
