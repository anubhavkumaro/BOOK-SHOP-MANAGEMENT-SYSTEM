<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdatePublishers.aspx.cs" Inherits="Publishers" %>
...
<body class="bodyimage">
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="Button5" runat="server" Text="Update" OnClick="Button5_Click" style="height: 26px" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="508px" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
            <Columns>
